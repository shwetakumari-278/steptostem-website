        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              and building responsive, interactive websites using HTML, CSS, and
              JavaScript.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              understanding structure, design, and interactivity — without heavy
              theory.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-8 max-w-3xl">
              Students grow from beginners to confident creators through guided,
