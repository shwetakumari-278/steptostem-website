  ...
  testimonials: [
    {
      ...
      rating: 4.9,
      text: "I created my own AI video with an avatar and voiceover without using a camera. It felt like I was building something from the future.",
    },
    {
      name: "Zayan Mirza",
      ...
      rating: 5.0,
      text: "I built my own website using AI and even added smart features to it. Seeing it go live made me really excited.",
    },
    {
      name: "Deepa Krishnan",
      role: "Parent",
      ...
      rating: 4.9,
      text: "My child is not just using AI anymore — she is creating videos, presentations, and even websites with it. The confidence boost has been incredible.",
    },
    {
      name: "Tanvir Hussain",
      role: "Grade 6 Student",
      ...
      rating: 4.8,
      text: "I learned how to automate tasks and build a small AI agent. It felt like having my own assistant that actually works for me.",
    },
  ],
},
"genai-web-dev": {
